...
<h2>Next stop: Login!</h2>
<p>${_('The Ringo application framework provides already some basic functionality which is ready for use in your fresh created application. It time to make a tour in your application to get a better impression of what is already included and how things work.<br></br>Please login withe the following credentials:') | n}</p>
<ul>
