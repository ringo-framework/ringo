...
class BaseItemTests(BaseUnitTest):
    ...
    def test_json(self):
        ...
        self.assertEqual(result, '[{"str_repr": "", "uuid": "", "display": "admin-menu", "description": "", "label": "Modul", "label_plural": "Modules", "id": "1", "clazzpath": "ringo.model.modul.ModulItem", "name": "modules"}]')
