...
Extend/Modify an existing ringo modul in your application
=========================================================
...
There are several ways how to do this. You can do one or more of the following
options to modifiy the view, model or logic of the modul.
